...
test.describe('Authentication', () => {
  test.describe('Login Page', () => {
    ...
    test('should display login form', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="email"], input[type="email"]')
      ).toBeVisible();
      await expect(
        page.locator('[data-testid="password"], input[type="password"]')
      ).toBeVisible();
      await expect(
        page.locator('[data-testid="login-button"], button[type="submit"]')
      ).toBeVisible();
    });
    ...
    test('should show validation errors for empty fields', async ({ page }) => {
      ...
      await expect(
        page.locator('text=/email.*required/i, text=/email.*invalid/i')
      ).toBeVisible();
    ...
    test('should show error for invalid credentials', async ({ page }) => {
      ...
      await expect(
        page.locator(
          'text=/invalid.*credentials/i, text=/login.*failed/i, [data-testid="error-message"]'
        )
      ).toBeVisible();
    });
    ...
    test('should have link to registration page', async ({ page }) => {
      const signUpLink = page.locator(
        'a[href*="register"], a[href*="signup"], text=/sign up/i, text=/create account/i'
      );
    ...
    test('should have forgot password link', async ({ page }) => {
      const forgotPasswordLink = page.locator(
        'a[href*="forgot"], a[href*="reset"], text=/forgot.*password/i'
      );
  ...
  test.describe('Registration Page', () => {
    ...
    test('should display registration form', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="register-button"], button[type="submit"]')
      ).toBeVisible();
    });
    ...
    test('should show validation errors for invalid email', async ({
      ...
      await expect(
        page.locator('text=/email.*invalid/i, text=/valid.*email/i')
      ).toBeVisible();
    });
    ...
    test('should show validation errors for weak password', async ({
      ...
      await expect(
        page.locator(
          'text=/password.*weak/i, text=/password.*short/i, text=/password.*requirements/i'
        )
      ).toBeVisible();
    });
    ...
    test('should have link to login page', async ({ page }) => {
      const loginLink = page.locator(
        'a[href*="login"], text=/sign in/i, text=/already.*account/i'
      );
  ...
  test.describe('Social Authentication', () => {
    ...
    test('should display social login options', async ({ page }) => {
      ...
      const facebookButton = page.locator(
        'button:has-text("Facebook"), [data-testid="facebook-login"]'
      );
