...
(0, cucumber_1.Given)(
  ...
  async function () {
    try {
      ...
      (0, child_process_1.execSync)('docker-compose --version', {
        stdio: 'pipe',
      });
...
(0, cucumber_1.Given)(
  ...
  async function () {
    try {
      const nodeVersion = (0, child_process_1.execSync)('node --version', {
        encoding: 'utf8',
      }).trim();
      ...
      try {
        switch (service.Service) {
          ...
          case 'API Gateway':
            ...
            const apiResponse = await axios_1.default.get(
...
(0, cucumber_1.Then)(
  ...
  async function () {
    ...
    try {
      ...
      const runningServices = (0, child_process_1.execSync)(
...
(0, cucumber_1.Then)(
  ...
  async function () {
    for (const workflow of this.workflows) {
      (0, test_1.expect)(workflow.content).toMatch(
...
(0, cucumber_1.Then)(
  ...
  async function () {
    ...
    (0, test_1.expect)(ciWorkflow.content).toMatch(
...
(0, cucumber_1.Then)(
  ...
  async function () {
    ...
    (0, test_1.expect)(securityWorkflow.content).toMatch(
      /(trivy|snyk|codeql|semgrep)/i
    );
  }
);
...
(0, cucumber_1.Then)(
  ...
  async function () {
    if (fs.existsSync('.env.example')) {
      ...
      (0, test_1.expect)(envExample).not.toMatch(
        /password123|secret123|admin/i
      ); // No weak defaults
    }
  }
);
