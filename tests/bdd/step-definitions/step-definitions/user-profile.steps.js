...
(0, cucumber_1.Then)('I should see my basic information', async function () {
    ...
    await (0, test_1.expect)(this.page.locator('[data-testid="profile-name"]')).toBeVisible();
    await (0, test_1.expect)(this.page.locator('[data-testid="profile-age"]')).toBeVisible();
});
...
(0, cucumber_1.Then)('my profile should display the updated information', async function () {
    ...
    if (this.testData.updatedName) {
        ...
        await (0, test_1.expect)(nameElement).toContainText(this.testData.updatedName);
    }
    if (this.testData.updatedAge) {
        const ageElement = this.page.locator('[data-testid="profile-age"]');
        await (0, test_1.expect)(ageElement).toContainText(this.testData.updatedAge);
    }
    if (this.testData.updatedBio) {
        const bioElement = this.page.locator('[data-testid="profile-bio"]');
        await (0, test_1.expect)(bioElement).toContainText(this.testData.updatedBio);
    }
});
...
(0, cucumber_1.Then)('the photo should be added to my profile', async function () {
...
(0, cucumber_1.Then)('I should see the new photo in my photo gallery', async function () {
    await this.waitForElement('[data-testid="profile-photos"]');
    const photos = this.page.locator('[data-testid="profile-photo"]');
    const photoCount = await photos.count();
    (0, test_1.expect)(photoCount).toBeGreaterThan(0);
...
(0, cucumber_1.When)('I drag and drop photos to reorder them', async function () {
    const firstPhoto = this.page.locator('[data-testid="profile-photo"]').first();
    const secondPhoto = this.page.locator('[data-testid="profile-photo"]').nth(1);
...
(0, cucumber_1.Then)('the photo should be removed from my profile', async function () {
...
(0, cucumber_1.When)('I add new interests {string}', async function (interests) {
...
(0, cucumber_1.When)('I remove existing interest {string}', async function (interest) {
...
(0, cucumber_1.Then)('my interests should be updated', async function () {
    ...
    if (this.testData.newInterests) {
        for (const interest of this.testData.newInterests) {
            const interestElement = this.page.locator(`[data-testid="interest-${interest}"]`);
            await (0, test_1.expect)(interestElement).toBeVisible();
        }
    }
    // Check removed interest is not displayed
    if (this.testData.removedInterest) {
        const removedInterestElement = this.page.locator(`[data-testid="interest-${this.testData.removedInterest}"]`);
        await (0, test_1.expect)(removedInterestElement).not.toBeVisible();
    }
});
(0, cucumber_1.Then)('I should see the new interests displayed', async function () {
    await this.waitForElement('[data-testid="profile-interests"]');
    const interestsContainer = this.page.locator('[data-testid="profile-interests"]');
...
(0, cucumber_1.Then)('my location should be updated', async function () {
    ...
    await (0, test_1.expect)(locationElement).toContainText(this.testData.updatedCity);
});
(0, cucumber_1.Then)('I should see the new location displayed', async function () {
    await this.waitForElement('[data-testid="profile-location"]');
    const locationElement = this.page.locator('[data-testid="profile-location"]');
...
(0, cucumber_1.Then)('I should see a validation error for name', async function () {
...
(0, cucumber_1.When)('I enter a bio longer than 500 characters', async function () {
...
(0, cucumber_1.When)('I send a PUT request to {string} with updated profile data', async function (endpoint) {
    ...
    this.testData.lastApiResponse = await this.apiRequest('PUT', endpoint, updatedProfile);
});
(0, cucumber_1.When)('I send a POST request to {string} with a photo file', async function (endpoint) {
    const formData = new FormData();
    const blob = new Blob(['fake-image-data'], { type: 'image/jpeg' });
    formData.append('photo', blob, 'test-photo.jpg');
    this.testData.lastApiResponse = await this.apiRequest('POST', endpoint, formData);
});
(0, cucumber_1.Given)('I have a photo with ID {string}', async function (photoId) {
...
(0, cucumber_1.When)('I send a PUT request to {string} with invalid data', async function (endpoint) {
    ...
    this.testData.lastApiResponse = await this.apiRequest('PUT', endpoint, invalidProfile);
});
(0, cucumber_1.When)('I send a POST request to {string} with an unsupported file format', async function (endpoint) {
    const formData = new FormData();
...
(0, cucumber_1.Then)('the response should contain my profile data', async function () {
    (0, test_1.expect)(this.testData.lastApiResponse.data).toHaveProperty('profile');
...
(0, cucumber_1.Then)('the profile data should include name, age, bio, photos, and interests', async function () {
    const profile = this.testData.lastApiResponse.data.profile;
    (0, test_1.expect)(profile).toHaveProperty('name');
    (0, test_1.expect)(profile).toHaveProperty('age');
...
(0, cucumber_1.Then)('the response should contain the updated profile', async function () {
    (0, test_1.expect)(this.testData.lastApiResponse.data).toHaveProperty('profile');
    const profile = this.testData.lastApiResponse.data.profile;
    (0, test_1.expect)(profile.name).toBe('Updated Name');
    (0, test_1.expect)(profile.age).toBe(30);
});
(0, cucumber_1.Then)('the profile should be updated in the database', async function () {
...
(0, cucumber_1.Then)('the response should contain the photo URL', async function () {
    (0, test_1.expect)(this.testData.lastApiResponse.data).toHaveProperty('photoUrl');
    (0, test_1.expect)(typeof this.testData.lastApiResponse.data.photoUrl).toBe('string');
});
(0, cucumber_1.Then)('the photo should be added to my profile', async function () {
...
(0, cucumber_1.Then)('the photo should be removed from my profile', async function () {
    ...
    const profileResponse = await this.apiRequest('GET', '/api/profile');
    const photos = profileResponse.data.profile.photos;
    const photoExists = photos.some((photo) => photo.id === this.testData.photoId);
...
(0, cucumber_1.Then)('the response should contain a file format error', async function () {
    (0, test_1.expect)(this.testData.lastApiResponse.data).toHaveProperty('error');
    (0, test_1.expect)(this.testData.lastApiResponse.data.error).toContain('format');
});
// Privacy Steps
...
(0, cucumber_1.When)('I set my profile to {string}', async function (visibility) {
    const visibilitySelect = this.page.locator('[data-testid="profile-visibility-select"]');
...
(0, cucumber_1.Then)('my profile should not be visible to other users', async function () {
...
(0, cucumber_1.When)('I choose to hide my age', async function () {
    const hideAgeCheckbox = this.page.locator('[data-testid="hide-age-checkbox"]');
    await hideAgeCheckbox.check();
});
(0, cucumber_1.Then)('my age should not be visible to other users', async function () {
...
(0, cucumber_1.Then)('other profile information should remain visible', async function () {
    const response = await this.apiRequest('GET', '/api/profile/public');
...
(0, cucumber_1.When)('I follow the verification instructions', async function () {
...
(0, cucumber_1.Then)('I should see a verification pending status', async function () {
    await this.waitForElement('[data-testid="verification-pending"]');
    const pendingStatus = this.page.locator('[data-testid="verification-pending"]');
    await (0, test_1.expect)(pendingStatus).toBeVisible();
});
(0, cucumber_1.Then)('I should receive a confirmation message', async function () {
    await this.waitForElement('[data-testid="verification-confirmation"]');
    const confirmation = this.page.locator('[data-testid="verification-confirmation"]');
...
(0, cucumber_1.Then)('I should see additional customization options', async function () {
    await this.waitForElement('[data-testid="premium-customization"]');
    const premiumOptions = this.page.locator('[data-testid="premium-customization"]');
...
(0, cucumber_1.Then)('I should see advanced privacy controls', async function () {
    await this.waitForElement('[data-testid="advanced-privacy-controls"]');
    const advancedControls = this.page.locator('[data-testid="advanced-privacy-controls"]');
...
(0, cucumber_1.Then)('all buttons should be easily tappable', async function () {
...
(0, cucumber_1.Then)('the photo upload should work on mobile', async function () {
    await this.clickElement('[data-testid="add-photo-button"]');
    const fileInput = this.page.locator('input[type="file"]');
...
// Accessibility Steps
(0, cucumber_1.Then)('all interactive elements should have proper ARIA labels', async function () {
...
(0, cucumber_1.Then)('the page should be navigable with keyboard', async function () {
    // Test keyboard navigation
    await this.page.keyboard.press('Tab');
    const focusedElement = await this.page.locator(':focus').first();
    await (0, test_1.expect)(focusedElement).toBeVisible();
});
(0, cucumber_1.Then)('images should have appropriate alt text', async function () {
...
(0, cucumber_1.Then)('form fields should have proper labels', async function () {
    ...
    for (let i = 0; i < fieldCount; i++) {
        ...
        const associatedLabel = await this.page.locator(`label[for="${await field.getAttribute('id')}"]`).count();
        (0, test_1.expect)(label || labelledBy || associatedLabel > 0).toBeTruthy();
    }
});
// Performance Steps
(0, cucumber_1.Then)('the page should load within 3 seconds', async function () {
...
(0, cucumber_1.Then)('photos should load progressively', async function () {
    ...
    const hasLoadingState = await firstPhoto.locator('[data-testid="photo-loading"]').isVisible();
    const hasProgressiveLoading = await firstPhoto.getAttribute('loading') === 'lazy';
    (0, test_1.expect)(hasLoadingState || hasProgressiveLoading).toBeTruthy();
});
(0, cucumber_1.Then)('the interface should remain responsive during loading', async function () {
...
(0, cucumber_1.Then)('the changes should be synced to the server', async function () {
...
(0, cucumber_1.Then)('I should see how many people viewed my profile', async function () {
...
(0, cucumber_1.Then)('I should see which photos are most popular', async function () {
...
(0, cucumber_1.Then)('I should see profile completion percentage', async function () {
    await this.waitForElement('[data-testid="profile-completion"]');
    const completionPercentage = this.page.locator('[data-testid="profile-completion"]');
