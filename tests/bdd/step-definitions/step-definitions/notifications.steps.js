...
(0, cucumber_1.Given)(
  'I am on the notification settings page',
  async function () {
...
(0, cucumber_1.Given)(
  'I have enabled real-time notifications',
  async function () {
    await this.apiRequest('PUT', '/api/notifications/preferences', {
...
(0, cucumber_1.Given)(
  'I have an unread notification with ID {string}',
...
(0, cucumber_1.Given)(
  'I have a notification with ID {string}',
  async function (notificationId) {
    const notification = {
      id: notificationId,
      type: 'like',
...
(0, cucumber_1.Given)(
  'I have various types of notifications',
  async function () {
...
(0, cucumber_1.Given)(
  'I receive multiple like notifications',
  async function () {
...
(0, cucumber_1.Given)(
  'I have enabled vibration for notifications',
  async function () {
    await this.apiRequest('PUT', '/api/notifications/preferences', {
...
(0, cucumber_1.Given)(
  'I receive notifications while offline',
  async function () {
...
(0, cucumber_1.Given)(
  'I have multiple pending notifications',
  async function () {
...
(0, cucumber_1.When)('I toggle push notifications off', async function () {
  const pushToggle = this.page.locator(
...
(0, cucumber_1.When)(
  'I enable notifications for matches only',
  async function () {
...
(0, cucumber_1.When)('I disable notifications for messages', async function () {
  const messageToggle = this.page.locator(
    '[data-testid="messages-notifications-checkbox"]'
  );
...
(0, cucumber_1.When)('I read a notification', async function () {
  const firstUnreadNotification = this.page
...
(0, cucumber_1.When)(
  'I send a PUT request to {string} with updated settings',
  async function (endpoint) {
...
(0, cucumber_1.Then)('I should receive a push notification', async function () {
  ...
  const pushNotification = this.page.locator(
    '[data-testid="push-notification"]'
  );
  await (0, test_1.expect)(pushNotification).toBeVisible();
});
(0, cucumber_1.Then)(
  'the notification should contain the match information',
  async function () {
    const notificationContent = this.page.locator(
...
(0, cucumber_1.Then)(
  'the notification should have a deep link to the match',
  async function () {
    const notificationLink = this.page.locator(
...
(0, cucumber_1.Then)(
  'the notification should contain the message preview',
  async function () {
    const notificationContent = this.page.locator(
      '[data-testid="notification-content"]'
    );
    await (0, test_1.expect)(notificationContent).toContainText(
      'Hello! How are you?'
    );
  }
);
(0, cucumber_1.Then)(
  'the notification should have a deep link to the conversation',
  async function () {
    const notificationLink = this.page.locator(
      '[data-testid="notification-link"]'
    );
...
(0, cucumber_1.Then)(
  'I should see a list of my notifications',
  async function () {
    await this.waitForElement('[data-testid="notifications-list"]');
    const notificationsList = this.page.locator(
...
(0, cucumber_1.Then)(
  'each notification should show the type and timestamp',
  async function () {
    const notifications = this.page.locator(
      '[data-testid="notification-item"]'
    );
    ...
    await (0, test_1.expect)(
      firstNotification.locator('[data-testid="notification-type"]')
    ).toBeVisible();
    await (0, test_1.expect)(
      firstNotification.locator('[data-testid="notification-timestamp"]')
    ).toBeVisible();
  }
);
(0, cucumber_1.Then)(
  ...
  async function () {
    const unreadNotifications = this.page.locator(
...
(0, cucumber_1.Then)(
  ...
  async function () {
    ...
    const readNotification = this.page.locator(
...
(0, cucumber_1.Then)(
  'the notification count should decrease',
  async function () {
    ...
    (0, test_1.expect)(count).toBeLessThan(
      this.testData.unreadNotifications.length
    );
  }
);
(0, cucumber_1.Then)(
  'I should be navigated to the relevant content',
  async function () {
...
(0, cucumber_1.Then)(
  'the notification count should be zero',
  async function () {
    const notificationBadge = this.page.locator(
      '[data-testid="notification-badge"]'
    );
...
(0, cucumber_1.Then)(
  'I should receive an email notification',
  async function () {
    // Check for email notification (this would typically involve checking email service)
    const emailResponse = await this.apiRequest(
      'GET',
      '/api/notifications/emails/recent'
    );
...
(0, cucumber_1.Then)(
  'the email should contain match details',
  async function () {
    const emailResponse = await this.apiRequest(
      'GET',
      '/api/notifications/emails/recent'
...
(0, cucumber_1.Then)(
  'the email should have a link to view the match',
  async function () {
    const emailResponse = await this.apiRequest(
      'GET',
      '/api/notifications/emails/recent'
...
(0, cucumber_1.Then)('I should receive a digest email', async function () {
  const emailResponse = await this.apiRequest(
    'GET',
    '/api/notifications/emails/digest'
  );
  (0, test_1.expect)(emailResponse.status).toBe(200);
  (0, test_1.expect)(emailResponse.data.digest).toBeDefined();
});
(0, cucumber_1.Then)(
  'the email should contain my activity summary',
  async function () {
    const emailResponse = await this.apiRequest(
      'GET',
      '/api/notifications/emails/digest'
...
(0, cucumber_1.Then)(
  'the email should contain new matches and messages',
  async function () {
    const emailResponse = await this.apiRequest(
      'GET',
      '/api/notifications/emails/digest'
...
(0, cucumber_1.Then)(
  ...
  async function () {
    const settingsResponse = await this.apiRequest(
      'GET',
      '/api/notifications/preferences'
    );
    (0, test_1.expect)(
      settingsResponse.data.preferences.pushNotifications
    ).toBe(false);
  }
);
(0, cucumber_1.Then)(
  'I should not receive push notifications',
  async function () {
...
(0, cucumber_1.Then)(
  'I should only receive match notifications',
  async function () {
    const settingsResponse = await this.apiRequest(
      'GET',
      '/api/notifications/preferences'
...
(0, cucumber_1.Then)(
  'I should not receive message notifications',
  async function () {
    ...
    const notificationsResponse = await this.apiRequest(
      'GET',
      '/api/notifications'
    );
...
(0, cucumber_1.Then)(
  'I should not receive notifications during quiet hours',
  async function () {
...
(0, cucumber_1.Then)(
  'notifications should resume after quiet hours',
  async function () {
...
(0, cucumber_1.Then)(
  'I should see an in-app notification immediately',
  async function () {
    await this.waitForElement('[data-testid="in-app-notification"]');
    const inAppNotification = this.page.locator(
...
(0, cucumber_1.Then)(
  'the notification should appear without page refresh',
  async function () {
    // Verify notification appears via real-time update
    const notification = this.page.locator(
      '[data-testid="real-time-notification"]'
    );
    await (0, test_1.expect)(notification).toBeVisible();
  }
);
(0, cucumber_1.Then)(
  'I should see a notification badge with the count',
  async function () {
    const notificationBadge = this.page.locator(
      '[data-testid="notification-badge"]'
    );
...
(0, cucumber_1.Then)(
  'the badge count should update immediately',
  async function () {
    ...
    (0, test_1.expect)(newCount).toBeLessThan(
      this.testData.unreadNotifications.length
    );
  }
);
...
(0, cucumber_1.Then)(
  'the response should contain my notifications',
  async function () {
    (0, test_1.expect)(this.testData.lastApiResponse.data).toHaveProperty(
      'notifications'
    );
    (0, test_1.expect)(
      Array.isArray(this.testData.lastApiResponse.data.notifications)
    ).toBe(true);
  }
);
(0, cucumber_1.Then)(
  'each notification should have id, type, message, timestamp, and read status',
  async function () {
...
(0, cucumber_1.Then)(
  ...
  async function () {
    ...
    const verifyResponse = await this.apiRequest(
      'GET',
      `/api/notifications/${this.testData.testNotificationId}`
    );
    (0, test_1.expect)(verifyResponse.data.notification.read).toBe(true);
  }
);
(0, cucumber_1.Then)(
  'subsequent API calls should show the notification as read',
  async function () {
    const notificationsResponse = await this.apiRequest(
      'GET',
      '/api/notifications'
    ...
    const notification = notificationsResponse.data.notifications.find(
      n => n.id === this.testData.testNotificationId
    );
...
(0, cucumber_1.Then)(
  'subsequent API calls should not include the notification',
  async function () {
    const notificationsResponse = await this.apiRequest(
      'GET',
      '/api/notifications'
...
(0, cucumber_1.Then)(
  'the response should contain the updated preferences',
  async function () {
    (0, test_1.expect)(this.testData.lastApiResponse.data).toHaveProperty(
      'preferences'
    );
...
(0, cucumber_1.Then)(
  'my notification behavior should change accordingly',
  async function () {
    ...
    const deliveryResponse = await this.apiRequest(
      'GET',
...
(0, cucumber_1.Then)(
  'my notification preferences should remain unchanged',
  async function () {
    const currentPreferences = await this.apiRequest(
      'GET',
      '/api/notifications/preferences'
    );
    // Verify preferences haven't changed from invalid request
    (0, test_1.expect)(
      currentPreferences.data.preferences.pushNotifications
    ).toBe(true); // Should still be original value
  }
);
(0, cucumber_1.Then)(
  ...
  async function () {
    ...
    (0, test_1.expect)(typeof this.testData.lastApiResponse.data.error).toBe(
      'string'
    );
  }
);
...
(0, cucumber_1.Then)(
  'I should see match notifications with heart icons',
  async function () {
    const matchNotifications = this.page.locator(
      '[data-testid="notification-item"][data-type="match"]'
    );
    const heartIcon = matchNotifications
      .first()
      .locator('[data-testid="heart-icon"]');
    await (0, test_1.expect)(heartIcon).toBeVisible();
  }
);
(0, cucumber_1.Then)(
  'I should see message notifications with chat icons',
  async function () {
    const messageNotifications = this.page.locator(
      '[data-testid="notification-item"][data-type="message"]'
    );
    const chatIcon = messageNotifications
      .first()
      .locator('[data-testid="chat-icon"]');
    await (0, test_1.expect)(chatIcon).toBeVisible();
  }
);
(0, cucumber_1.Then)(
  'I should see like notifications with thumbs up icons',
  async function () {
    const likeNotifications = this.page.locator(
      '[data-testid="notification-item"][data-type="like"]'
    );
    const thumbsUpIcon = likeNotifications
      .first()
      .locator('[data-testid="thumbs-up-icon"]');
    await (0, test_1.expect)(thumbsUpIcon).toBeVisible();
  }
);
(0, cucumber_1.Then)(
  'I should see system notifications with info icons',
  async function () {
    const systemNotifications = this.page.locator(
      '[data-testid="notification-item"][data-type="system"]'
    );
    const infoIcon = systemNotifications
      .first()
      .locator('[data-testid="info-icon"]');
    await (0, test_1.expect)(infoIcon).toBeVisible();
  }
);
(0, cucumber_1.Then)('it should be marked as high priority', async function () {
  const priorityNotification = this.page.locator(
    '[data-testid="notification-item"][data-priority="high"]'
  );
  await (0, test_1.expect)(priorityNotification).toBeVisible();
});
(0, cucumber_1.Then)(
  'it should appear at the top of the notification list',
  async function () {
    const firstNotification = this.page
      .locator('[data-testid="notification-item"]')
      .first();
...
(0, cucumber_1.Then)(
  'it should have a distinct visual indicator',
  async function () {
    const priorityIndicator = this.page.locator(
...
(0, cucumber_1.Then)(
  'similar notifications should be grouped together',
  async function () {
    const groupedNotification = this.page.locator(
      '[data-testid="grouped-notification"]'
    );
    await (0, test_1.expect)(groupedNotification).toBeVisible();
  }
);
(0, cucumber_1.Then)(
  'I should see a summary like {string}',
  async function (summaryText) {
    const summaryElement = this.page.locator(
...
(0, cucumber_1.Then)(
  'I should be able to expand to see individual notifications',
  async function () {
    const expandButton = this.page.locator(
      '[data-testid="expand-notifications"]'
    );
    await expandButton.click();
    const individualNotifications = this.page.locator(
      '[data-testid="individual-notification"]'
    );
...
(0, cucumber_1.Then)(
  'I should hear the match notification sound',
  async function () {
...
(0, cucumber_1.Then)(
  'I should hear the message notification sound',
  async function () {
...
(0, cucumber_1.Then)('the device should vibrate', async function () {
  ...
  const vibrationTrigger = this.page.locator(
    '[data-testid="vibration-triggered"]'
  );
  await (0, test_1.expect)(vibrationTrigger).toBeVisible();
});
(0, cucumber_1.Then)(
  'the vibration pattern should match the notification type',
  async function () {
    const vibrationPattern = await this.page
      .locator('[data-testid="vibration-pattern"]')
...
(0, cucumber_1.Then)(
  ...
  async function () {
    ...
    const pushNotifications = this.page.locator(
      '[data-testid="push-notification"]'
    );
...
(0, cucumber_1.Then)(
  'I should still see in-app notifications when I open the app',
  async function () {
    const inAppNotifications = this.page.locator(
      '[data-testid="in-app-notification"]'
    );
...
(0, cucumber_1.Then)(
  'notifications should be queued for later delivery',
  async function () {
    const queuedNotifications = await this.apiRequest(
      'GET',
      '/api/notifications/queued'
    );
    (0, test_1.expect)(queuedNotifications.data.queued.length).toBeGreaterThan(
      0
    );
  }
);
...
(0, cucumber_1.Then)(
  'the notification panel should be touch-friendly',
  async function () {
    const notificationItems = this.page.locator(
      '[data-testid="notification-item"]'
    );
...
(0, cucumber_1.Then)(
  'notifications should be easy to swipe and dismiss',
  async function () {
    const firstNotification = this.page
      .locator('[data-testid="notification-item"]')
      .first();
...
(0, cucumber_1.Then)(
  'the notification layout should be optimized for mobile',
  async function () {
    const notificationPanel = this.page.locator(
...
(0, cucumber_1.Then)(
  'all notifications should have proper ARIA labels',
  async function () {
    const notifications = this.page.locator(
      '[data-testid="notification-item"]'
    );
...
(0, cucumber_1.Then)(
  'I should be able to navigate notifications with keyboard',
  async function () {
    await this.page.keyboard.press('Tab');
    const focusedElement = await this.page.locator(':focus').first();
    await (0, test_1.expect)(focusedElement).toHaveAttribute(
      'data-testid',
      'notification-item'
    );
  }
...
(0, cucumber_1.Then)(
  'notification actions should be accessible',
  async function () {
...
(0, cucumber_1.Then)(
  'the notifications should load within 2 seconds',
  async function () {
...
(0, cucumber_1.Then)(
  'scrolling through notifications should be smooth',
  async function () {
    const notificationsList = this.page.locator(
      '[data-testid="notifications-list"]'
    );
...
(0, cucumber_1.Then)('the app should remain responsive', async function () {
  ...
  const navigationButton = this.page.locator(
...
(0, cucumber_1.Then)(
  'I should receive all missed notifications',
  async function () {
    const notificationsResponse = await this.apiRequest(
      'GET',
      '/api/notifications'
    ...
    (0, test_1.expect)(notifications.length).toBeGreaterThanOrEqual(
      offlineNotificationCount
    );
  }
);
(0, cucumber_1.Then)(
  'notifications should be delivered in the correct order',
  async function () {
    const notificationsResponse = await this.apiRequest(
      'GET',
      '/api/notifications'
    ...
    for (let i = 1; i < notifications.length; i++) {
      ...
      (0, test_1.expect)(currentTimestamp.getTime()).toBeLessThanOrEqual(
...
// Privacy Assertions
(0, cucumber_1.Then)(
  'the notification should not show the message content',
  async function () {
    const notificationContent = this.page.locator(
      '[data-testid="notification-content"]'
    );
...
(0, cucumber_1.Then)(
  'the notification should only show {string}',
...
(0, cucumber_1.Then)(
  'I should need to open the app to see the content',
  async function () {
    ...
    await (0, test_1.expect)(messageContent).toContainText(
      'Hello! How are you?'
    );
  }
);
...
(0, cucumber_1.Then)(
  'I should receive notifications in a single batch',
  async function () {
    const batchNotification = this.page.locator(
      '[data-testid="batch-notification"]'
    );
    await (0, test_1.expect)(batchNotification).toBeVisible();
  }
);
(0, cucumber_1.Then)(
  'the notifications should be ordered by priority',
  async function () {
    const notifications = this.page.locator(
      '[data-testid="notification-item"]'
    );
...
(0, cucumber_1.Then)(
  'I should not be overwhelmed with individual notifications',
  async function () {
    // Verify that notifications are batched rather than sent individually
    const individualNotifications = this.page.locator(
      '[data-testid="individual-push-notification"]'
    );
    const count = await individualNotifications.count();
...
(0, cucumber_1.Then)(
  'I should be taken to the unsubscribe page',
  async function () {
    await this.waitForElement('[data-testid="unsubscribe-page"]');
    const unsubscribePage = this.page.locator(
...
(0, cucumber_1.Then)(
  'I should be able to choose which emails to unsubscribe from',
  async function () {
...
(0, cucumber_1.Then)(
  'my preferences should be updated immediately',
  async function () {
    await this.clickElement('[data-testid="unsubscribe-button"]');
    // Verify preferences are updated
    const preferencesResponse = await this.apiRequest(
      'GET',
      '/api/notifications/preferences'
    );
    (0, test_1.expect)(
      preferencesResponse.data.preferences.emailNotifications
    ).toBe(false);
  }
);
(0, cucumber_1.Then)(
  'I should see delivery rates for different notification types',
  async function () {
...
(0, cucumber_1.Then)(
  'I should see user engagement with notifications',
  async function () {
    await this.waitForElement('[data-testid="engagement-metrics"]');
    const engagementMetrics = this.page.locator(
...
(0, cucumber_1.Then)(
  'I should see notification performance metrics',
  async function () {
    await this.waitForElement('[data-testid="performance-metrics"]');
    const performanceMetrics = this.page.locator(
