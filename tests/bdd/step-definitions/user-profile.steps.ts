...
When('I update my name to {string}', async function (this: CustomWorld, newName: string) {
  await this.fillField('[data-testid="name-input"]', newName);
  this.testData.updatedName = newName;
});

When('I update my age to {string}', async function (this: CustomWorld, newAge: string) {
  await this.fillField('[data-testid="age-input"]', newAge);
  this.testData.updatedAge = newAge;
});

When('I update my bio to {string}', async function (this: CustomWorld, newBio: string) {
...
Then('my profile should display the updated information', async function (this: CustomWorld) {
...
Then('the photo should be added to my profile', async function (this: CustomWorld) {
...
Then('I should see the new photo in my photo gallery', async function (this: CustomWorld) {
  await this.waitForElement('[data-testid="profile-photos"]');
  const photos = this.page!.locator('[data-testid="profile-photo"]');
  const photoCount = await photos.count();
  expect(photoCount).toBeGreaterThan(0);
...
When('I drag and drop photos to reorder them', async function (this: CustomWorld) {
...
Then('the photo should be removed from my profile', async function (this: CustomWorld) {
...
When('I add new interests {string}', async function (this: CustomWorld, interests: string) {
...
When('I remove existing interest {string}', async function (this: CustomWorld, interest: string) {
...
Then('I should see the new interests displayed', async function (this: CustomWorld) {
  await this.waitForElement('[data-testid="profile-interests"]');
...
When('I enter a new city {string}', async function (this: CustomWorld, city: string) {
...
Then('I should see the new location displayed', async function (this: CustomWorld) {
  await this.waitForElement('[data-testid="profile-location"]');
  const locationElement = this.page!.locator('[data-testid="profile-location"]');
...
Then('I should see a validation error for name', async function (this: CustomWorld) {
...
When('I enter a bio longer than 500 characters', async function (this: CustomWorld) {
...
Then('I should see an age validation error', async function (this: CustomWorld) {
...
When('I send a PUT request to {string} with updated profile data', async function (this: CustomWorld, endpoint: string) {
...
When('I send a POST request to {string} with a photo file', async function (this: CustomWorld, endpoint: string) {
...
Given('I have a photo with ID {string}', async function (this: CustomWorld, photoId: string) {
...
When('I send a POST request to {string} with an unsupported file format', async function (this: CustomWorld, endpoint: string) {
  const formData = new FormData();
...
Then('the response should contain my profile data', async function (this: CustomWorld) {
...
Then('the profile data should include name, age, bio, photos, and interests', async function (this: CustomWorld) {
  const profile = this.testData.lastApiResponse.data.profile;
  expect(profile).toHaveProperty('name');
  expect(profile).toHaveProperty('age');
...
Then('the response should contain the updated profile', async function (this: CustomWorld) {
  expect(this.testData.lastApiResponse.data).toHaveProperty('profile');
  const profile = this.testData.lastApiResponse.data.profile;
...
Then('the profile should be updated in the database', async function (this: CustomWorld) {
...
Then('the response should contain the photo URL', async function (this: CustomWorld) {
...
Then('the photo should be removed from my profile', async function (this: CustomWorld) {
  ...
  const profileResponse = await this.apiRequest('GET', '/api/profile');
  const photos = profileResponse.data.profile.photos;
  const photoExists = photos.some((photo: any) => photo.id === this.testData.photoId);
...
Then('the response should contain a file format error', async function (this: CustomWorld) {
...
When('I set my profile to {string}', async function (this: CustomWorld, visibility: string) {
...
Then('my profile should not be visible to other users', async function (this: CustomWorld) {
...
Then('I should not appear in discovery', async function (this: CustomWorld) {
  ...
  const myProfile = profiles.find((p: any) => p.id === this.testData.currentUser.id);
...
Then('my age should not be visible to other users', async function (this: CustomWorld) {
...
Then('other profile information should remain visible', async function (this: CustomWorld) {
  const response = await this.apiRequest('GET', '/api/profile/public');
...
When('I follow the verification instructions', async function (this: CustomWorld) {
...
Then('I should see a verification pending status', async function (this: CustomWorld) {
...
Then('I should receive a confirmation message', async function (this: CustomWorld) {
...
Then('I should see additional customization options', async function (this: CustomWorld) {
...
Then('I should see advanced privacy controls', async function (this: CustomWorld) {
...
Then('all buttons should be easily tappable', async function (this: CustomWorld) {
...
Then('the photo upload should work on mobile', async function (this: CustomWorld) {
  await this.clickElement('[data-testid="add-photo-button"]');
  const fileInput = this.page!.locator('input[type="file"]');
...
// Accessibility Steps
Then('all interactive elements should have proper ARIA labels', async function (this: CustomWorld) {
...
Then('the page should be navigable with keyboard', async function (this: CustomWorld) {
...
Then('images should have appropriate alt text', async function (this: CustomWorld) {
...
Then('form fields should have proper labels', async function (this: CustomWorld) {
...
// Performance Steps
Then('the page should load within 3 seconds', async function (this: CustomWorld) {
...
Then('the interface should remain responsive during loading', async function (this: CustomWorld) {
...
Then('the changes should be synced to the server', async function (this: CustomWorld) {
...
Then('I should see how many people viewed my profile', async function (this: CustomWorld) {
...
Then('I should see which photos are most popular', async function (this: CustomWorld) {
...
Then('I should see profile completion percentage', async function (this: CustomWorld) {
