...
Given(
  'I have enabled weekly digest emails',
...
Given(
  ...
  async function (this: CustomWorld, notificationId: string) {
    const notification = {
      id: notificationId,
      type: 'message',
...
Given(
  'I receive a super like notification',
  async function (this: CustomWorld) {
...
When('I click on a notification', async function (this: CustomWorld) {
  const firstNotification = this.page!.locator(
...
When(
  'I disable notifications for messages',
  async function (this: CustomWorld) {
...
When(
  'I set quiet hours from 10 PM to 8 AM',
  async function (this: CustomWorld) {
...
When('I read a notification', async function (this: CustomWorld) {
  const firstUnreadNotification = this.page!.locator(
...
Then(
  'I should receive a push notification',
  async function (this: CustomWorld) {
...
Then(
  'it should be marked as high priority',
  async function (this: CustomWorld) {
...
Then(
  ...
  async function (this: CustomWorld, summaryText: string) {
...
Then(
  ...
  async function (this: CustomWorld) {
    const vibrationPattern = await this.page!.locator(
      '[data-testid="vibration-pattern"]'
...
Then(
  ...
  async function (this: CustomWorld) {
    ...
    for (let i = 1; i < notifications.length; i++) {
      ...
      expect(currentTimestamp.getTime()).toBeLessThanOrEqual(
...
Then(
  ...
  async function (this: CustomWorld) {
    ...
    const messageContent = this.page!.locator(
