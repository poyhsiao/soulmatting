...
Given(
  'I am a new user with valid registration data',
...
Given(
  'I have valid user registration data',
  async function (this: CustomWorld) {
    const testUser = this.generateTestUser();
...
Given(
  'I have invalid user registration data',
  async function (this: CustomWorld) {
    const invalidUser = {
      email: 'invalid-email',
...
When(
  'I enter an invalid email format {string}',
  async function (this: CustomWorld, email: string) {
...
When(
  'I enter a valid password {string}',
...
When(
  'I try to register with the same email {string}',
  async function (this: CustomWorld, email: string) {
    await this.fillField('[data-testid="email-input"]', email);
  }
);
...
When(
  'I register a new user with password {string}',
  async function (this: CustomWorld, password: string) {
    const user = {
...
When(
  'I check the user data in the database',
  async function (this: CustomWorld) {
...
Then(
  'I should be redirected to the profile setup page',
  async function (this: CustomWorld) {
...
Then(
  'I should remain on the registration page',
  async function (this: CustomWorld) {
...
Then(
  'the response should contain the user ID',
  async function (this: CustomWorld) {
...
Then(
  'no user should be created in the database',
  async function (this: CustomWorld) {
    const invalidUser = this.getTestData('invalidUser');
    ...
    await this.makeApiRequest(
      'GET',
      `/api/users/by-email/${invalidUser.email}`
    );
...
Then(
  'the password hash should be verifiable',
  async function (this: CustomWorld) {
...
// Accessibility steps
Then(
  'the form should have proper ARIA labels',
  async function (this: CustomWorld) {
...
Then(
  'the form should have a logical tab order',
  async function (this: CustomWorld) {
...
Then(
  'the form should be properly displayed on mobile',
  async function (this: CustomWorld) {
    await this.assertElementVisible('[data-testid="registration-form"]');
...
Then(
  'all form fields should be easily accessible',
  async function (this: CustomWorld) {
...
Then(
  'the submit button should be clearly visible',
  async function (this: CustomWorld) {
