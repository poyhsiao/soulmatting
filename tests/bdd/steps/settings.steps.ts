...
Given(
  'I am on the discovery settings page',
  async function (this: CustomWorld) {
    await this.page.goto('/settings/discovery');
    await this.page.waitForSelector(
      '[data-testid="discovery-settings-content"]'
    );
  }
);
...
Given(
  ...
  async function (this: CustomWorld) {
    ...
    await this.page.waitForSelector(
      '[data-testid="notification-settings-content"]'
    );
  }
);
...
When(
  'I enter a new email address {string}',
...
When(
  'I toggle {string} off',
  async function (this: CustomWorld, settingName: string) {
...
When(
  'I set my distance range to {string}',
...
When(
  'I select interested in {string}',
  async function (this: CustomWorld, interest: string) {
    await this.page.selectOption(
      '[data-testid="interested-in-select"]',
      interest
    );
  }
);
...
When('I disable push notifications', async function (this: CustomWorld) {
  const toggle = await this.page.locator(
...
When(
  'I enable email notifications for matches only',
  async function (this: CustomWorld) {
...
When(
  'I set quiet hours from {int} PM to {int} AM',
  async function (this: CustomWorld, startHour: number, endHour: number) {
    await this.page.selectOption(
...
When(
  'I see a warning about permanent deletion',
  async function (this: CustomWorld) {
...
When('I select a reason for leaving', async function (this: CustomWorld) {
  await this.page.selectOption(
    '[data-testid="deletion-reason-select"]',
    'Found someone'
  );
});
...
When(
  'I scan the QR code with my authenticator app',
  async function (this: CustomWorld) {
...
When(
  'I send a PUT request to {string} with updated preferences',
  async function (this: CustomWorld, endpoint: string) {
    ...
    this.testData.apiResponse = await this.apiClient.put(
      endpoint,
      updatedSettings
    );
  }
...
When(
  'I send a PUT request to {string} with current and new password',
  async function (this: CustomWorld, endpoint: string) {
    const passwordData = {
...
// Assertion steps
Then(
  'I should see my current email address',
  async function (this: CustomWorld) {
    const email = this.testData.user?.email || 'test@example.com';
    await expect(
      this.page.locator('[data-testid="current-email"]')
    ).toContainText(email);
  }
);

Then(
  'I should see my account creation date',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="account-created-date"]')
    ).toBeVisible();
  }
);
...
Then('I should see my subscription status', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="subscription-status"]')
  ).toBeVisible();
});

Then(
  'I should see options to change my password',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="change-password-button"]')
    ).toBeVisible();
  }
);

Then(
  'I should see options to delete my account',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="delete-account-button"]')
    ).toBeVisible();
  }
);
...
Then('I should see a confirmation message', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="confirmation-message"]')
  ).toBeVisible();
});
...
Then(
  'my email should be updated after verification',
  async function (this: CustomWorld) {
...
Then(
  ...
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="password-strength-error"]')
    ).toBeVisible();
  }
);
...
Then('I should see password requirements', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="password-requirements"]')
  ).toBeVisible();
});

Then(
  'my privacy settings should be updated',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="settings-updated-message"]')
    ).toBeVisible();
  }
);
...
Then(
  'my discovery preferences should be updated',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="discovery-settings-saved"]')
    ).toBeVisible();
  }
);

Then(
  'I should see matches within my criteria',
  async function (this: CustomWorld) {
...
Then('I should see all blocked users', async function (this: CustomWorld) {
  ...
  for (const user of blockedUsers) {
    await expect(
      this.page.locator(`[data-testid="blocked-user-${user.id}"]`)
    ).toBeVisible();
  }
});
...
Then('I should be able to unblock users', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="unblock-button"]').first()
  ).toBeVisible();
});

Then(
  'they should be removed from my blocked list',
  async function (this: CustomWorld) {
...
Then(
  'they should be able to see my profile again',
  async function (this: CustomWorld) {
...
Then(
  'I should only receive email notifications for matches',
  async function (this: CustomWorld) {
    // This would be verified in notification tests
...
Then(
  ...
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="account-deletion-scheduled"]')
    ).toBeVisible();
  }
);
...
Then(
  'I should return to the settings page',
  async function (this: CustomWorld) {
    await expect(
...
Then(
  'the response should contain my current settings',
  async function (this: CustomWorld) {
...
Then(
  'the response should include privacy preferences',
  async function (this: CustomWorld) {
...
Then(
  'the response should include notification preferences',
  async function (this: CustomWorld) {
    expect(this.testData.apiResponse?.data.settings).toHaveProperty(
      'notifications'
    );
  }
);
...
Then(
  'the response should include discovery preferences',
  async function (this: CustomWorld) {
    expect(this.testData.apiResponse?.data.settings).toHaveProperty(
      'discovery'
    );
...
Then(
  'the response should confirm the settings update',
  async function (this: CustomWorld) {
...
Then(
  'subsequent API calls should return the updated settings',
  async function (this: CustomWorld) {
...
Then(
  'the response should confirm password change',
  async function (this: CustomWorld) {
    expect(this.testData.apiResponse?.data).toHaveProperty('message');
...
Then(
  'I should be able to authenticate with the new password',
  async function (this: CustomWorld) {
...
Then(
  'the response should confirm account deletion',
  async function (this: CustomWorld) {
    expect(this.testData.apiResponse?.data).toHaveProperty('message');
...
Then(
  'subsequent API calls should return {int} unauthorized',
  async function (this: CustomWorld, statusCode: number) {
    // This would be verified with another API call
...
Then(
  'the settings menu should be touch-friendly',
  async function (this: CustomWorld) {
...
Then(
  'all options should be easily accessible',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="settings-menu"]')
    ).toBeVisible();
  }
);

Then(
  'the layout should be optimized for mobile',
  async function (this: CustomWorld) {
...
Then(
  'all settings should have proper labels',
  async function (this: CustomWorld) {
...
Then(
  'all toggles should be announced correctly',
  async function (this: CustomWorld) {
...
Then(
  'I should be able to navigate with keyboard only',
  async function (this: CustomWorld) {
...
Then(
  'all form fields should have descriptive labels',
  async function (this: CustomWorld) {
...
Then(
  'all settings should be loaded progressively',
  async function (this: CustomWorld) {
    // Verify progressive loading
    await expect(
      this.page.locator('[data-testid="settings-skeleton"]')
    ).toBeHidden();
  }
);

Then(
  'the page should remain responsive during updates',
  async function (this: CustomWorld) {
...
Then('the changes should be saved locally', async function (this: CustomWorld) {
  ...
  const localChanges = await this.page.evaluate(() =>
    localStorage.getItem('pendingSettingsChanges')
  );
  expect(localChanges).toBeTruthy();
});

Then(
  'the changes should sync to the server',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="sync-success-message"]')
    ).toBeVisible();
  }
);

Then(
  'I should see a confirmation of successful sync',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="sync-confirmation"]')
    ).toBeVisible();
  }
);
...
// Premium assertions
Then(
  'I should see additional privacy options',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="premium-privacy-options"]')
    ).toBeVisible();
  }
);

Then(
  'I should see advanced filtering options',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="advanced-filters"]')
    ).toBeVisible();
  }
);
...
Then('I should see options to hide ads', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="hide-ads-option"]')
  ).toBeVisible();
});

Then(
  'I should see priority support options',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="priority-support"]')
    ).toBeVisible();
  }
);
...
Then(
  'I should receive an email when the export is ready',
  async function (this: CustomWorld) {
...
Then(
  'the export should contain all my profile data',
  async function (this: CustomWorld) {
...
Then(
  'the export should contain my match history',
  async function (this: CustomWorld) {
    // This would be verified by checking the export file
...
Then(
  'the export should contain my message history',
  async function (this: CustomWorld) {
    // This would be verified by checking the export file
...
Then(
  'I should be able to export my data in standard formats',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="export-format-options"]')
    ).toBeVisible();
  }
);

Then(
  'I should receive instructions for importing to other services',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="import-instructions"]')
    ).toBeVisible();
  }
);

Then(
  'the export should be completed within {int} days',
...
// Security assertions
Then(
  '{int}FA should be enabled on my account',
  async function (this: CustomWorld, factor: number) {
    await expect(
      this.page.locator('[data-testid="2fa-enabled-status"]')
    ).toBeVisible();
  }
);
...
Then(
  'I should need {int}FA for future logins',
  async function (this: CustomWorld, factor: number) {
    // This would be verified in login tests
...
Then('I should see recent login attempts', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="recent-logins"]')
  ).toBeVisible();
});
...
Then('I should see location information', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="location-info"]')
  ).toBeVisible();
});

Then(
  'I should be able to log out other devices',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="logout-other-devices"]')
    ).toBeVisible();
  }
);
...
Then('I should see my profile view count', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="profile-views"]')
  ).toBeVisible();
});
...
Then('I should see my response rate', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="response-rate"]')
  ).toBeVisible();
});

Then('I should see trends over time', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="analytics-chart"]')
  ).toBeVisible();
});
...
Then('I should see my current plan', async function (this: CustomWorld) {
  ...
  await expect(this.page.locator('[data-testid="current-plan"]')).toContainText(
    plan
  );
});
...
Then('I should see my next billing date', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="next-billing-date"]')
  ).toBeVisible();
});

Then(
  'I should see options to upgrade or downgrade',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="plan-options"]')
    ).toBeVisible();
  }
);

Then(
  'I should see options to cancel subscription',
  async function (this: CustomWorld) {
    await expect(
      this.page.locator('[data-testid="cancel-subscription"]')
    ).toBeVisible();
  }
);
...
Then('my subscription should be cancelled', async function (this: CustomWorld) {
  await expect(
    this.page.locator('[data-testid="subscription-cancelled"]')
  ).toBeVisible();
});

Then(
  'I should retain premium features until the end of the billing period',
  async function (this: CustomWorld) {
...
Then(
  'I should receive a cancellation confirmation email',
  async function (this: CustomWorld) {
