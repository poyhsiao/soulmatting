...
(0, cucumber_1.When)(
  ...
  async function (startHour, endHour) {
    await this.page.selectOption(
...
(0, cucumber_1.Then)(
  ...
  async function () {
    (0, test_1.expect)(this.testData.apiResponse?.data).toHaveProperty(
      'settings'
    );
  }
);
(0, cucumber_1.Then)(
  ...
  async function () {
    (0, test_1.expect)(this.testData.apiResponse?.data.settings).toHaveProperty(
      'privacy'
    );
  }
);
...
(0, cucumber_1.Then)(
  ...
  async function () {
    ...
    (0, test_1.expect)(this.testData.apiResponse?.data.message).toContain(
      'updated'
    );
  }
);
...
(0, cucumber_1.Then)('I should see backup codes', async function () {
  await (0, test_1.expect)(
    this.page.locator('[data-testid="backup-codes"]')
  ).toBeVisible();
});
(0, cucumber_1.Then)(
...
(0, cucumber_1.Then)('I should see device information', async function () {
  await (0, test_1.expect)(
    this.page.locator('[data-testid="device-info"]')
  ).toBeVisible();
});
...
(0, cucumber_1.Then)('I should see my match rate', async function () {
  await (0, test_1.expect)(
    this.page.locator('[data-testid="match-rate"]')
  ).toBeVisible();
});
...
(0, cucumber_1.Then)('I should see my current plan', async function () {
  ...
  await (0, test_1.expect)(
    this.page.locator('[data-testid="current-plan"]')
  ).toContainText(plan);
});
