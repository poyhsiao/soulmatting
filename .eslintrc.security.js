  ...
  rules: {
    ...
    'no-restricted-globals': [
      ...
      },
      {
        name: 'Function',
        message:
          'Use of Function constructor is not allowed for security reasons.',
      },
    ],
    ...
    'no-restricted-syntax': [
      ...
      },
      {
        ...
        message:
          'Use of innerHTML can lead to XSS vulnerabilities. Use textContent or a sanitization library.',
      },
      {
        selector: 'CallExpression[callee.property.name="outerHTML"]',
        message:
          'Use of outerHTML can lead to XSS vulnerabilities. Use a sanitization library.',
      },
      {
        selector:
          'CallExpression[callee.name="setTimeout"][arguments.0.type="Literal"]',
        message:
          'setTimeout with string argument can lead to code injection. Use function instead.',
      },
      {
        selector:
          'CallExpression[callee.name="setInterval"][arguments.0.type="Literal"]',
        message:
          'setInterval with string argument can lead to code injection. Use function instead.',
      },
    ],
        ...
        patterns: [
          {
            group: ['child_process'],
            message:
              'Use of child_process should be carefully reviewed for security implications.',
          },
          {
            group: ['vm'],
            message:
              'Use of vm module should be carefully reviewed for security implications.',
          },
          {
            group: ['fs'],
            message:
              'Direct file system access should be carefully reviewed. Consider using path validation.',
          },
        ],
      },
    ],
      ...
      rules: {
        ...
        'no-restricted-syntax': [
          'error',
          {
            ...
            message:
              'Raw SQL queries with template literals can lead to SQL injection. Use parameterized queries.',
          },
          {
            selector:
              'CallExpression[callee.property.name="raw"][arguments.0.type="TemplateLiteral"]',
            message:
              'Raw SQL queries with template literals can lead to SQL injection. Use parameterized queries.',
          },
        ],
      ...
      rules: {
        'no-restricted-syntax': [
          'error',
          {
            ...
            message:
              'dangerouslySetInnerHTML can lead to XSS vulnerabilities. Use a sanitization library.',
          },
          {
